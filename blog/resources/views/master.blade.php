...
<body class="">
	<header style="text-align: center; background-color: #3D9970; padding:20px; position: relative;">
		<div class="row">
			<div class="col-md-6">
				<h2><img style="margin-right:20px;" src="{{ asset('uploads/logo.png') }}" width="50"><a style="color: white; text-transform: uppercase; font-weight: bold" href="{{url('/')}}">Hội Nghị Khoa Học</a>
					<h2>
			</div>
			<div class="col-md-6">
				<h2 style="padding-top:10px;"><a style="color: white; text-transform: uppercase; font-weight: bold" href="{{url('/login')}}">Đăng nhập</a>
					<h2>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-6" id="search-menu">
				<form action="{{url('search')}}" id="search-form" method="POST">
					<input type="text" placeholder="Tìm kiếm hội nghị" id="timkiemhoinghi" name="timkiemhoinghi" style="height: 40px; width: 500px; font-size:15px;" />
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-3">
						...
						<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d979.5583593088326!2d106.803364!3d10.8698416!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317527587e9ad5bf%3A0xafa66f9c8be3c91!2sUniversity+of+Information+Technology+VNU-HCM!5e0!3m2!1sen!2s!4v1561888070187!5m2!1sen!2s" 
